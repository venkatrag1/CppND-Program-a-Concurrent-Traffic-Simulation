...
// DONE: FP.3 Define a class „MessageQueue“ which has the public methods send
...
// DONE: FP.1 : Define a class „TrafficLight“ which is a child class of
...
public:
  ...
  TrafficLight(); // Override default constructor, to initialize _currentPhase
...
private:
  ...
  // DONE: FP.4b : create a private member of type MessageQueue for messages of
